...
public class OrderPageUi {
	...
	public static final String ACCOUNT_DROPDOWN ="//div[@id='place-order-container']/div/div/div[1]/div[5]/div[2]/div[1]/div";
...
//	public static final String PRICE_INPUT1= "//input[@placeholder='Nhập giá']";
	public static final String MASS_INPUT = "//input[@name='input-volume-place-order']";
	public static final String BUY_ORDER_BTN = "//button[text()='ĐẶT LỆNH MUA']";
	...
	public static final String GETTEXT_TC_PRICE = "//div[text()='TC']/following-sibling::div";
	public static final String BUY_VERIFY_BTN = "//button[text()='Xác nhận mua']";
	public static final String SENDKEY_OTP_CODE = "//input[@placeholder='Nhập mã']";
	public static final String VERIFY_BUY_SUCCESS ="//div[text()='Đặt lệnh thành công']";
	public static final String ACCOUNT_NAME = "//div[@class='styles__MasterAcount-sc-87xawv-2 dsyDIJ']";
	public static final String ACCOUNT_LIST_DROPDOWN = "//div[@class=' css-11unzgr']/div";
	public static final String SMS_OTP_BTN = "//div[text()='SMS OTP']";
	public static final String SMS_CONFIRM_BTN = "//button[text()='Xác nhận']";
